...
public class BrowseGankRVFragment extends Fragment {
    ...
    public static BrowseGankRVFragment newInstance(String tag){
        final BrowseGankRVFragment browseGankRVFragment =new BrowseGankRVFragment();
        final Bundle args=new Bundle();
        args.putString("tag",tag);
        browseGankRVFragment.setArguments(args);
        return browseGankRVFragment;
    }
