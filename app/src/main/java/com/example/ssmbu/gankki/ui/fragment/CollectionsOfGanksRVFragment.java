...
public class CollectionsOfGanksRVFragment extends Fragment {
    ...
    public static CollectionsOfGanksRVFragment newInstance(String tag){
        final CollectionsOfGanksRVFragment fragment =new CollectionsOfGanksRVFragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mGankPresenter.getCollectionsByTag(mTag);
    ...
    private void initView(){
        ...
        mBrowseGankAdapter =new BrowseGankAdapter(mGankItems,CollectionsOfGanksRVFragment.this);
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if(newState==RecyclerView.SCROLL_STATE_IDLE){
                    if(!recyclerView.canScrollVertically(1)){
                        mGankPresenter.getCollectionsByTag(mTag,COUNT,String.valueOf(mPage++));
                        //mGankPresenter.getGanksByTag(mTag,COUNT,String.valueOf(mPage++));
